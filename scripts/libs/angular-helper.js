...
(function(window, angular, undefined) {'use strict';
	...
	angular.inArray = function(value, array) {
		if (Array.prototype.indexOf) return array.indexOf(value);
		else {
	...
	// NameSpace Function Defination
	angular.namespace = function(query, space, token) {
		if ('string' !== typeof query) return undefined;

		for (var i = 0, re = space, ns = query.split(token || '.'); i < ns.length; i ++) {
